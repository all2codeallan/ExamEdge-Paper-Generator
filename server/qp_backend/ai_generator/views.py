...
from api.models import Course # Assuming Course model is in api.models
...
class DownloadGeneratedPaperView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        # These prefixes should also use forward slashes
        safe_prefixes = ['media/', 'generated_papers/']
